object ScalaTestExample4a {
  ...
  def tax(income:Int):Double=income*0.12 //tax is a function that takes an integer and returns an integer
 
  def takeHome(hour1:Int,hour2:Int):Double=income(hour1,hour2)-tax(income(hour1,hour2)) //takeHome is a function that takes an integer and returns an integer

  printf("%d\n",income(40,30)) //prints out the income of 40 hours and 30 hours
  printf("%d\n",takeHome(income(40,30))) //prints out the takeHome of 40 hours and 30 hours
